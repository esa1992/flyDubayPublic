...
public class Flyght {
    ...
    public FlyghtStatus getFlyghtStatus() {
        return flyghtStatus;
    }

    public void setFlyghtStatus(FlyghtStatus flyghtStatus) {
        this.flyghtStatus = flyghtStatus;
    }

    private FlyghtStatus flyghtStatus;
